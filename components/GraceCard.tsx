    ...
    <div className="glass-panel p-8 md:p-12 rounded-2xl max-w-xl w-full flex flex-col space-y-8 border-white/5">
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-4">
        ...
        <Link 
          ...
          className="flex-1 border border-white/20 text-white px-8 py-4 rounded-full font-medium text-center hover:bg-white/5 transition-all duration-300 uppercase tracking-widest text-xs"
        >
          Denominational
        </Link>
      </div>
      
      <div className="pt-6 flex items-center space-x-2 text-[10px] text-white/20 uppercase tracking-[0.2em]">
