...
export default function NameCapture({ onComplete }: NameCaptureProps) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <p className="text-xs uppercase tracking-[0.2em] text-black/50">Grace asks</p>
        <p className="text-lg font-serif italic text-black">"What name should I call you?"</p>
        ...
        <div className="space-y-3">
          <input
            ...
            className="w-full bg-white/5 border border-black/10 rounded-full px-4 py-2 text-sm text-black focus:outline-none focus:border-white/30 transition-colors text-center"
