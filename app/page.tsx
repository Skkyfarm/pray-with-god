...
export default function Home() {
  ...
  const traditions = [
  {
  ...
  },
    {
      ...
      avatar: AVATARS.protestant,
    },
    {
      name: 'Catholic',
      path: '/pray?path=catholic',
      avatar: AVATARS.catholic,
    },
    {
      name: 'Exploring',
    ...
    {
      name: 'Jewish',
      path: '/pray?path=jewish',
      avatar: AVATARS.jewish,
    },
    {
      name: 'Muslim',
      path: '/pray?path=muslim',
      avatar: AVATARS.muslim,
    },
    {
      name: 'Buddhist',
      path: '/pray?path=buddhist',
      avatar: AVATARS.buddhist,
    },
    {
      name: 'Hindu',
      path: '/pray?path=hindu',
      avatar: AVATARS.hindu,
    },
  ];

  return (
    <main className="relative min-h-screen overflow-hidden bg-transparent text-black">
      <section className="relative flex flex-col items-center px-4 pb-8 pt-4 sm:px-6 md:px-6 md:pb-10 md:pt-7">
        <div className="relative z-10 flex w-full max-w-6xl flex-col items-center text-center">
          <div className="mb-4 max-w-3xl space-y-2 md:mb-5">
              ...
              {traditions.map((t) => (
                <Link key={t.name} href={t.path} className="group block h-full">
                  <div className="glass-panel flex h-full min-h-[96px] flex-col items-center justify-center rounded-2xl border border-black/10 bg-white/35 p-2 text-center shadow-[0_10px_30px_rgba(255,255,255,0.18)] transition-all duration-500 ease-out hover:-translate-y-1.5 hover:scale-[1.05] hover:border-violet-400/90 hover:bg-white/55 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.86),0_0_20px_rgba(255,255,255,0.92),0_0_42px_rgba(139,92,246,0.58),0_0_78px_rgba(91,33,182,0.42),0_0_110px_rgba(49,46,129,0.28)] md:min-h-[116px] md:p-4">
                    <div className="mb-2 h-11 w-11 md:h-14 md:w-14">
                      <GuideAvatar
                    ...
                    <span className="text-[9px] font-semibold uppercase tracking-[0.12em] text-black md:text-[10px] md:tracking-widest">
                      {t.name}
                    </span>
                  </div>
                </Link>
          ...
          <p className="mb-5 max-w-2xl text-sm leading-relaxed text-black md:mb-6 md:text-base">
            Begin with the tradition that feels closest to home — or start with
          ...
          <div className="grid w-full max-w-4xl gap-3 md:grid-cols-2">
            <div className="glass-panel rounded-[1.5rem] border border-black/10 bg-white/35 px-5 py-4 text-left shadow-sm">
              ...
              <p className="mt-2 text-sm leading-relaxed text-black md:text-base">
                A quiet place for believers, seekers, and anyone who needs a
                moment of prayer.
              </p>
            </div>
            ...
            <div className="glass-panel rounded-[1.5rem] border border-black/10 bg-white/35 px-5 py-4 text-left shadow-sm">
              ...
              <p className="mt-2 text-sm leading-relaxed text-black md:text-base">
                Prayer is free for everyone. Support PWG to save prayers and
