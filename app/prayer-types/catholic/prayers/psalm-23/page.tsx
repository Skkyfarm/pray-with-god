...
const entry = getNamedPrayerDetail("catholic", "psalm-23");

if (!entry) {
  throw new Error("Missing named prayer detail: catholic/psalm-23");
}
...
export default function CatholicPsalm23Page() {
