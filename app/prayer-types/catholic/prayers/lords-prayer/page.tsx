...
const entry = getNamedPrayerDetail("catholic", "lords-prayer");

if (!entry) {
  throw new Error("Missing named prayer detail: catholic/lords-prayer");
}
...
export default function CatholicLordsPrayerPage() {
