...
const entry = getNamedPrayerDetail("protestant", "hannahs-prayer");

if (!entry) {
  throw new Error("Missing named prayer detail: protestant/hannahs-prayer");
}
...
export default function ProtestantHannahsPrayerPage() {
