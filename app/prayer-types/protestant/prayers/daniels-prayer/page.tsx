...
const entry = getNamedPrayerDetail("protestant", "daniels-prayer");

if (!entry) {
  throw new Error("Missing named prayer detail: protestant/daniels-prayer");
}
...
export default function ProtestantDanielsPrayerPage() {
