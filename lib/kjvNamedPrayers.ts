...
export const HIGH_PRIESTLY_PRAYER_KJV = `These words spake Jesus, and lifted up his eyes to heaven, and said, Father, the hour is come; glorify thy Son, that thy Son also may glorify thee:
...
export const SOLOMONS_PRAYER_OF_DEDICATION_KJV = `And Solomon stood before the altar of the LORD in the presence of all the congregation of Israel, and spread forth his hands toward heaven:
...
export const KJV_NAMED_PRAYER_TEXTS: Record<string, string> = {
  ...
  "Jesus' High Priestly Prayer": HIGH_PRIESTLY_PRAYER_KJV,
  "Solomon's Prayer of Dedication": SOLOMONS_PRAYER_OF_DEDICATION_KJV,
